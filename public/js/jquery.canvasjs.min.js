...
(function () {
    ...
    var t = !!document.createElement("canvas").getContext, la = {
        Chart: {
            ...
            colorSet: "colorSet1",
            culture: "en",
            creditText: "Real Time Chart Interlista Network",
    ...
    u.prototype._updateOptions =
        function () {
            ...
            if ("undefined" === typeof la.Chart.creditHref)this.creditHref = "http://interlista.com.lk/", this.creditText = "Interlista Real Time Disaster Chart"; else var c = this.updateOption("creditText"), d = this.updateOption("creditHref");
